...
#! Pembuatan Icon Window 

app_icon = PhotoImage(file = 'Images/Icons/launchericon.png')
root.iconphoto(False, app_icon)


#? Function pembukaan file aplikasi dan penutupan launcher 
...
#^ Pembuatan dan penempatan label menggunakan grid 
...
#! Function format dan loop jam 

def display():
   jam.config(text = strftime(' %H:%M:%S '))
   jam.after(1, display)


#? Pembuatan dan penempatan semua tombol serta penggabungan dengan aktivasi function animasi serta pembukaan file aplikasi dan penutupan launcher 
...
#! Aktivasi function format dan loop jam 
